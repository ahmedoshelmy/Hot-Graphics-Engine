...
namespace our {
    ...
    // This component denotes that the Camera will move the owning entity using user inputs.
    ...
    public:
        ...
        glm::vec3 positionSensitivity = {15.0f, 15.0f, 15.0f}; // The unity per second of camera movement if WASD is pressed
        float speedupFactor = 3.0f; // A multiplier for the positionSensitivity if "Left Shift" is held.

        // The ID of this component type is "Camera Controller"
        static std::string getID() {return "Camera Controller";} 
