...
namespace our {
    ...
    class PickingSystem {
        ...
        std::vector<std::string> inventoryEntities = {"key1", "key2", "key3", "key4", "key5", "key6", "key7", "key8",
                                                      "key9"};
    ...
    public:
        ...
        void update(our::World *world, our::Application *app, TextRenderer *renderer, double deltaTime);
