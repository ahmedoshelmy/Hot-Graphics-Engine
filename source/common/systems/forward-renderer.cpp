...
namespace our {
    ...
    void ForwardRenderer::destroy(){
        ...
        // Delete all objects related to text rendering
    ...
    void ForwardRenderer::renderText(std::string text, float x, float y, float scale, glm::vec3 color, int text_align_x, int text_align_y) {
